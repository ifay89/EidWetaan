...
// Load the image
$image = imagecreatefrompng($config['cards_dir'].$_POST['selectphoto'].".png");
...
$y = 985; // You can adjust this similarly for vertical centering

// Write the text on the image
imagettftext($image, $fontSize, $angle, $x, $y, $textColor, $font, $renderedText);

// Encode the Arabic filename for the png file
